...
int process_c(char* p_dest, param_t params, int value);
int process_s(char* p_dest, param_t params, char* value);
int process_f(char* p_dest, param_t params, long double value);
int process_e(char* p_dest, param_t params, long double value, bool capital,
              bool from_g);
